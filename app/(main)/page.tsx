...
const brands = [
  {
    name: "DELABIE",
    desc: "Leader européen de la robinetterie pour lieux publics",
    color: "border-delabie-blue bg-delabie-blue-pale",
  },
  {
    name: "KWC",
    desc: "Mitigeurs et robinets cuisine & lavabo haut de gamme",
    color: "border-emerald-300 bg-emerald-50",
  },
  {
    name: "DVS",
    desc: "Équipements thermostatiques et hygiène professionnelle",
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-gradient-to-br from-delabie-blue via-delabie-blue-dark to-[#001a4d] text-white py-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            PartiQ digitalise vos documents techniques, centralise votre base de
            connaissances et répond instantanément à vos demandes SAV grâce à
            l&apos;intelligence artificielle.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/catalogue">
              <Button size="lg" variant="secondary" className="border-white/40">
                Voir le catalogue
              </Button>
            </Link>
            <Link href="/dashboard">
      ...
      <section className="py-20 px-4 bg-delabie-gray">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-delabie-text mb-3">
              Fonctionnalités clés
            </h2>
            <p className="text-delabie-gray-dark max-w-xl mx-auto">
              Une plateforme complète pour digitaliser et moderniser la gestion
              SAV des équipements sanitaires.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((f) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-delabie-text mb-1">
                    {f.title}
                  </h3>
                  <p className="text-sm text-delabie-gray-dark leading-relaxed">
                    {f.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-delabie-gray-dark">
              Bases de données produits unifiées pour trois marques leaders.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {brands.map((b) => (
              <div
                key={b.name}
                className={`rounded-2xl border-2 p-6 text-center ${b.color}`}
              >
                <p className="text-2xl font-bold text-delabie-text mb-2">
                  {b.name}
                </p>
      ...
      <section className="bg-delabie-blue py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-blue-200 mb-8">
            Essayez l&apos;assistant SAV ou explorez le catalogue de produits
            dès maintenant.
          </p>
      ...
      <footer className="bg-delabie-blue-dark text-blue-300 text-xs text-center py-4">
        PartiQ SAV — Démonstrateur IA pour la gestion SAV robinetterie · DELABIE
        · KWC · DVS
      </footer>
    </div>
  );
